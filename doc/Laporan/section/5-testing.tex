...
Untuk memastikan program berjalan dengan benar, dilakukan beberapa pengujian dengan beberapa kasus uji (\textit{test case}. Kasus uji yang digunakan adalah sebagai berikut.
\begin{enumerate}
...
\begin{itemize}
    \item Deskripsi: Papan $3 \times 3$ (Papan terlalu sempit tidak ada solusi)
    \item Output: \begin{figure}[htbp]
        \begin{center}
